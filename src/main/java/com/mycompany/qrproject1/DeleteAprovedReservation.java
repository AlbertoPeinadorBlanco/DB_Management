 ...
 * 
 * Class to delete approved reservations from the DB by id
 * child of DeleteData class
 */
public class DeleteAprovedReservation extends DeleteData {
    ...
    public void deleteData(String reservationID) {
         ...
         try{
            ...
            String sql = "DELETE FROM tb_aproved_reservations WHERE id = ?";
